 ...
 */
@Component
public class NaverShoppingKeywordCrawler extends BaseParser {
...
//	@Scheduled(cron = "0 0 13 * * MON")
	...
	public void getKeywords(String setDate, String endDate) {
		...
		for (Map<String, String> categoryInfo : categoryInfoList) {
			...
			request.openConnection(getContentURL);

			request.addRequestHeader("Host", "shopping.naver.com");
			request.addRequestHeader("Origin", "http://shopping.naver.com");
