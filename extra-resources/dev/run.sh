...
APP_HOME="/app/ec/samsungcnt/crawler"
APP_LOG="/app/ec/samsungcnt/crawler/logs"
APP_COMMAND=$1
...
if [ "$1" = "run" ] || [ "$1" = "execute" ] ; then
	...
	if [ "$1" = "run" ] ; then
        ...
        nohup $EXEC_JAVA -classpath bootstrap.jar -Dapp.home.dir=$APP_HOME $JAVA_OPTS Bootstrap $MAIN_CLASS $APP_COMMAND > nohup.out 2>&1 &
